...
def search_event_by_name(query: str, db: Session = Depends(get_db)):
...
def search_event_by_time_range(
    start_date: datetime,
    end_date: datetime,
...
def cancel_event_by_id(event_id: int, db: Session = Depends(get_db)):
